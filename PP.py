...
def pebble_predictor(**pars):
    ...
    rInt[0] = 1.5*rgrid[0]-0.5*rgrid[1]         # we need the location of the interfaces of the grid so that we can find the gradient of pressure from the left cell to the right cell in the grid.
